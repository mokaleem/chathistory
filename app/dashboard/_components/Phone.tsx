...
function Phone() {
  return (
    <div className="relative mx-auto border-gray-800 bg-gray-800 border-[6px] rounded-[2.5rem] h-[601px] w-[292px] phone-area-component max-h-screen">
